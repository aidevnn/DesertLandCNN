...
A poor but quick test. The actual code run very slowly. A futur update will introduce the Stride and the Storage and the View of NDarray for more performance.
